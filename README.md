...
data. And if *pose_reference_file* exist, copy pose from reference file to the new output file. The most common scenario of
...
nifti2cavass(input_file, output_file, modality, offset_value=0, pose_reference_file)
```
...
nifti_label2cavass(input_file, output_file, objects, modality, discard_background=True, pose_reference_file)
```
